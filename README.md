...
13 | Mar 09 | Stochastic Multi-Armed Bandits | LS, Chapter 4 (Stochastic Bandits) <br/> LS, Chapter 6 (The Explore-Then-Commit Algorithm) <br/> LS,  Chapter 7 (The Upper Confidence Bound Algorithm) <br/> Chapter 36 (Thompson Sampling) <br/> Chapter 22 (Pure Exploration) | [slides](slides/bandit_slides2.pdf) <br/><br/> zoom recording to be added
