...
08 | Feb 11 | Temporal Difference Methods | V, Section 4.2 (Temporal Difference Methods) <br/> SB, Chapter 6 (Temporal-Di↵erence Learning) | [slides](slides/TD-methods.pdf) <br/><br/> zoom recording to be added
